...
class API:
    def __init__(self):
        self.__VersionDictionary = {'FwMusic_Version': 'v2.0.0C',
                                    'API': 'v20C10',
...
class NcmApiManager:
    def __init__(self):
        ...
        self.vip_api_list = ['https://www.byfuns.top/api/1/?id=',
        ...
        self.vip_api_dict = {'Byfuns': 'https://www.byfuns.top/api/1/?id=',
                             ...
                             'Littleyouzi': 'https://api.littleyouzi.com/qq/api/music/net?mid='}
        ...
        for i in range(len(download_list_new)):
            try:
                if download_list[i][4]:  # Download vip
                    url = ncmApiManager.GetApi(self.api_type) + str(download_list[i][1])
                    filename = download_list[i][0]
                    filename = simpleapi.format(filename)
