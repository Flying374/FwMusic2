...
class API:
    def __init__(self):
        self.__VersionDictionary = {'FwMusic_Version': 'v2.0-b7',
                                    'API': 'v20007',
                                    'ArtistAPI': 'v3.0(250701)',
                                    'PlaylistAPI': 'v1.5(250724)',
                                    'PlaylistAPI_v2': 'v2.0(250820)',
        ...
        try:
            ...
            if a['code'] == 200 and a_p['code'] == 200:
                ...
                for c in b:
                    d = c['name']
                    e = c['id']
                    l = c['songs'][0]['ar'][0]['name']
                    m = c['songs'][0]['ar'][0]['Fid']
                    name_list.append(d)
                    id_list.append(e)
                ...
                flog.info('Succeeded in getting details. playlist id:' + self.playlist_id)
