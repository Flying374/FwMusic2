...
api = Fwapi.API()
if api.get_version()[0:4] != 'v202':
    exit('Error:API Version Valid.')

if os.path.exists('Logs/2025-10-18-22-30-52.txt'):
    exit('Error:API Version Valid.')


print('FwMusic v2.0.1C')
Vip_Api = 'Byfuns'
Enable = 'F'
...
while True:
    ...
    if ans == '1':
        ...
        print('Config')
        print('1:Enable VIP Api  2:Set VIP Api')
        a = input('>>>')
        if a == '1':
