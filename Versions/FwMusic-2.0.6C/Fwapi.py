...
class API:
    def __init__(self):
        self.__VersionDictionary = {'FwMusic_Version': 'v2.0.6C',
                                    'API': 'v20316',
                                    ...
                                    'Downloader_v3_Auto': 'v3.0(251220)',
...
class Playlist_v2:
    ...
    def get_details(self):
        ...
        try:
            ...
            page_url = ncmapi + '/playlist/track/all?id=' + str(playlist_id) + '&limit=1000&offset=1'
...
class Album:
    ...
    def get_details(self):
        try:
            ...
            page_url = 'https://music.163.com/album?id=' + str(self.album_id)  # no/#/
            res = requests.request('GET', page_url, headers=headers)
            html = etree.HTML(res.text)
            ...
            if len(song_names) == len(song_ids):
                ...
                raise Exception
            self.album_songs = playlist_songs
            time.sleep(5)
